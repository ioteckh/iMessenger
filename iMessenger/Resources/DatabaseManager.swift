        ...
        ref.observeSingleEvent(of: .value, with: {snapshot in
            ...
            if var conversations = userNode["conversations"] as? [[String: Any]]{
                ...
                ref.setValue(userNode, withCompletionBlock: {[weak self] error, _ in
                    ...
                    strongSelf.finishCreatingConversation(conversationID: conversationId, firstMessage: firstMessage, completion: completion)
                })
            }else{
...
//        }
    ...
    public func getAllConversations(for email: String, completion: (Result<String, Error>) -> Void){
